...
- **Debugging Timeouts:** If an element that _should_ appear quickly is consistently timing out, it's more likely a selector problem than a need for an excessively long timeout (e.g., >10-15s for a simple UI element).
