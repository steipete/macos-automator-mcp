...
const isSaveEnabled = process.menuBars[0].menuBarItems
  .byName("File")
  .menus[0].menuItems.byName("Save")
  .enabled();
```
...
const exportMenu = process.menuBars[0].menuBarItems
  .byName("File")
  .menus[0].menuItems.byName("Export As").menus[0];
