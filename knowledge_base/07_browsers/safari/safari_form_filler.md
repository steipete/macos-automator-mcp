---
title: Safari Form Filler
category: 07_browsers
id: safari_form_filler
description: >-
  Automates filling out web forms in Safari browser by providing
...
This script automates filling out web forms in Safari browser. It can be used for repetitive form tasks such as logins, data entry, or registration forms. The script operates by:

1. Opening a specified URL in Safari
...
```javascript
// Safari Form Filler
// Fills web forms with provided data in Safari
...
function fillForm(url, formData, selectors, submit, waitTime, fillDelay) {
    try {
        ...
        const result = safari.doJavaScript(jsScript, {in: safari.documents[0]});
